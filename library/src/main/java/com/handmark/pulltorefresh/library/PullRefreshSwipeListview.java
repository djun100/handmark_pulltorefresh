...
public class PullRefreshSwipeListview extends PullToRefreshAdapterViewBase<SwipeListView> {
	...
	public PullRefreshSwipeListview(Context context, Mode mode) {
		super(context, mode);
	}

	public PullRefreshSwipeListview(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY,
			...
			OverscrollHelper.overScrollBy(PullRefreshSwipeListview.this, deltaX, scrollX, deltaY,
	...
	protected class InternalListView extends SwipeListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PullRefreshSwipeListview.this.setEmptyView(emptyView);
		}
